...
public final class IconLoader {
    ...
    private static final ConcurrentMap<URL, CachedImageIcon> ourIconsCache = new ConcurrentHashMap<>(100, 0.9f, 2);
...
//    }
    ...
    public static final class CachedImageIcon implements ScalableIcon {
        ...
        private synchronized ImageIcon getRealIcon() {
            if (isLoaderDisabled() && (myRealIcon == null || dark != USE_DARK_ICONS || scale != SCALE || filter != IMAGE_FILTER))
                return EMPTY_ICON;
